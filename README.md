...
**NOTE:** Blue Iris appends the motion zone to the `&TYPE` macro (e.g. "MOTION_A"). The Component will only create a binary sensor for the "MOTION_A" topic (i.e. for a single motion trigger zone). If you need to utilize multiple motion zones, you may:
